...
notifyUserRemoved: (userPeerId: string, callParams: CallParams<'userPeerId'>) => void;
 ...
 export function registerFluentPad(service: FluentPadDef): void;
export function registerFluentPad(serviceId: string, service: FluentPadDef): void;
export function registerFluentPad(peer: FluencePeer, service: FluentPadDef): void;
export function registerFluentPad(peer: FluencePeer, serviceId: string, service: FluentPadDef): void;
 export function registerFluentPad(...args: any) {
